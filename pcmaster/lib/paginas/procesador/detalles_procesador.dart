...
class DetallesProcesador extends StatelessWidget {
  final Procesador procesador;

  DetallesProcesador({required this.procesador});
            ...
            Center(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text(
                    'Gama: ${procesador.gama}\nMarca: ${procesador.marca}\nPotencia: ${procesador.potencia}W\nSocket: ${procesador.socked}',
