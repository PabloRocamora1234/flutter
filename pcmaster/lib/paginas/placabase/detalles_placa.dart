...
class DetallesPlaca extends StatelessWidget {
  final Placa placa;

  DetallesPlaca({required this.placa});
            ...
            Center(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text(
                    'Marca: ${placa.marca}\nSocket: ${placa.socked}\nAlimentación: ${placa.alimentacion}\nPotencia: ${placa.potencia}W\nGama: ${placa.gama}\nConexiones: ${placa.conexiones}\nRAM: ${placa.ram}',
